...
const RemoveObject = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            // ✅ FIXED: Validation - check words, not characters
            const words = object.trim().split(/\s+/);
            if (words.length > 3) {
                toast.error('Please enter only 1-3 words');
                setLoading(false);
                return;
            }
            ...
            // ✅ ADDED: Loading toast with 10-20 seconds message
            toast.loading('Processing... Wait 10-20 seconds', { id: 'processing' });
